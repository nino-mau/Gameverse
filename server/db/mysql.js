...
// functions
import { insertInDb, selectInDb } from '../utils/database.js';
...
/**
 * Put refresh token (id, expire date) in DB,
 * will be used to create JWT token sent to frontend and verify it or revoke it after that
 */
...
export async function getAllUsersData() {
   ...
   if (r) {
      ...
      console.log('getAllUsersData: No users found in database');
      return false;
   }
}
